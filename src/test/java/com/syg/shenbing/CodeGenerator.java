...
import static com.syg.shenbing.core.ProjectConstant.BASE_PACKAGE;
import static com.syg.shenbing.core.ProjectConstant.MAPPER_INTERFACE_REFERENCE;

/**
 * 代码生成器
 * 根据数据表名称生成对应的Model、Mapper、Service、Controller简化开发。
 * @Author 田志武
 * @create 2021/3/23 13:06
 */
public class CodeGenerator {

    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/sys?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8&allowMultiQueries=true";
    ...
    private static final String AUTHOR = "田志武";//@author
